...
var MakeFormComponent = function(ComposedComponent) {
  class FormComponent extends React.Component {
    ...
    static propTypes = {
      asyncValidation: React.PropTypes.shape({
      ...
      inputBefore: React.PropTypes.node,
      isPartOfForm: React.PropTypes.bool,
      label: React.PropTypes.string,
      masker: React.PropTypes.shape({
        mask: React.PropTypes.func
      }),
      name: React.PropTypes.string,
      onChange: React.PropTypes.func,
      onInvalid: React.PropTypes.func,
      onMaskInvalid: React.PropTypes.func,
      onMaskValid: React.PropTypes.func,
      onValid: React.PropTypes.func,
      showValidationUI: React.PropTypes.bool,
